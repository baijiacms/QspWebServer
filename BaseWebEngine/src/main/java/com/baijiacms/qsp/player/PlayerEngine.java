...
public class PlayerEngine implements GameInterface {
    ...
    private int userId;
    public PlayerEngine(int userId) {
        this.userId=userId;
        gameStatus = new GameStatus();
        htmlProcessor = new HtmlProcessor();

        audioPlayer = new AudioPlayer();
        libQspProxy = new LibQspProxyImpl(userId,gameStatus, htmlProcessor, audioPlayer, this);
...
//        logger.info("showMenu");
    ...
    public String loadSaveGame(String filename) {
        ...
        String saveFolder = gameStatus.getSaveFolder()+userId+"/";
    ...
    public void deleteSaveGame(String filename) {
        if (true||StringUtils.isEmpty(filename)) {
            return;//todo not access
        }
    ...
    public void saveGame(String filename) {
        ...
        String saveFolder = gameStatus.getSaveFolder()+this.userId+"/";
...
//        logger.info("varsDesc:"+varsDesc);
    ...
    public LibQspProxyImpl getLibQspProxy() {
        return libQspProxy;
    }
